...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', '[REDACTED MAILGUN SMTP USER]')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', '[REDACTED MAILGUN SMTP PASSWORD]')
